...
Command-line control for the **Angry Miao AM Infinity .97**, over the same
vendor HID channel the official web configurator uses. No driver, no browser.
...
```
pip install hidapi
git clone https://github.com/TheMasterDingo/am97-cli
cd am97-cli
